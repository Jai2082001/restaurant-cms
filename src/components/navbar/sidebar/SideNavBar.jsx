...
export const sideNavItems = (role)=> {
    ...
    main: [
      {
        ...
        name: "Dashboard",
        url: "/dashboard/home",
        icon: (size = 21) => <MdDashboard size={size} />,
      },
    ],
    list: [],
    user: [
      {
        ...
        icon: (size= 21) => <MdManageAccounts size={size} />,
      },
      {
        id: 10,
        name: "Logout",
        url: "#",
        icon: (size = 21) => <MdLogin size={size} />,
    ...
    const adminRoutes = [
      {
        ...
        name: "Users",
        url: "/dashboard/users",
        icon: (size = 21) => <FaRegUser size={size} />,
      },
      {
        id: 3,
        name: "Products",
        url: "/dashboard/products",
        icon: (size= 21) => <FaBuilding size={size} />,
      },
    ];
