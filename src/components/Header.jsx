...
const Header = ({ siteInfo, toggleSidebar, isDarkMode, toggleDarkMode }) => {
    return (
      <header className="bg-white dark:bg-gray-800 shadow-md p-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white">{siteInfo && <><p>{siteInfo.Name}</p></>}</h1>
            {siteInfo && <><img style={{maxWidth: '100px'}} src={`${siteInfo.Logo}`}></img></>}
          </div>
          <div className="flex items-center space-x-4">
